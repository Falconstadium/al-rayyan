export const dagmusHoney = {
  ...
  fr: {
    ...
    benefit: {
      ...
      detail2:
        "Le miel de Dagmus contient de nombreux minéraux et vitamines. C’est une riche source de glucides et de sucre naturel. Il a également ses propriétés anti-inflammatoires, bactériennes et oxydantes et est un antibiotique puissant.",
    },
  },
  ...
  ar: {
    ...
    benefit: {
      ...
      detail1:
        "يتميز عسل الدغموس بلونه البني والأصفر، ولكن بعد فترة يستقر على الأسود، يكون عسل الدغموس طعمًا لاذعًا يترك شعورًا بالحرارة في منطقة الحلق عند تناوله.",
      detail2:
        "يحتوي عسل الدغموس على العديد من المعادن والفيتامينات المختلفة. إنه مصدر غني بالكربوهيدرات والسكر الطبيعي. كما أن لها خصائصها المضادة للالتهابات والبكتيريا والأكسدة وهي مضاد حيوي قوي.",
    },
  },
};
